...
namespace BITCollege_GiangHuynh.Controllers
{
    public class ProgramsController : Controller
    {
        ...
        {
            Program program = db.Programs.Find(id);
            // {Giang} The Courses in Collection ICollection<Course> will be removed from program
            program.Course.Clear();
            // {Giang} The Students in Collection ICollection<Student> will be removed from program
